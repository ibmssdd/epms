...
class MilestoneCalendarSvc {
  ...
  Future<void> saveMTCalender({
    required String milestoneType,
    required DateTime date,
    required List<Map<String, String>> scope,
    String? description,
  }) async {
    final type = milestoneType.trim().toUpperCase();
    ...
    final typeText = switch (type) {
      'CMT' => 'CMT: Coaching Milestone',
      'PMT' => 'PMT: Personal Milestone',
      'AITS' => 'AITS: PW - AITS',
      _ => throw ArgumentError('Invalid milestone type: $type'),
    };
